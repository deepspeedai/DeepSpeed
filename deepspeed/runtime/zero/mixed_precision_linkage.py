...
import types
from deepspeed.runtime.zero.tensor_fragment import get_full_hp_param, get_full_hp_grad, get_hp_fragment_mapping
from deepspeed.runtime.zero.tensor_fragment import set_full_hp_param, set_full_hp_grad
